...
class Articles extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $crud->unset_texteditor(array('meta_keywords','meta_description','full_text'));
        ...
        if ($table->uploads != '') {
            ...
            foreach ($fields_upload as $field_upload) {
                $crud->set_field_upload($field_upload, 'assets/uploads/blogs');
            }
        }
        ...
        "path_to_directory"       =>'assets/uploads/blogs/',
        ...
        $crud->order_by('articles_id','desc');
