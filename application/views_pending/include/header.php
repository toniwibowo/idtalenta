								...
								<div class="header-row">
										...
										<div class="header-nav-main header-nav-main-mobile-dark header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-effect-2 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													...
													<li class="dropdown">
														<a class="dropdown-item dropdown-toggle" href="<?= site_url('mentor') ?>">
															Mentor
														</a>
														<ul class="dropdown-menu">
															<li>
																<a class="dropdown-item" href="<?= site_url('mentor/detail') ?>">Detail</a>
															</li>
															<li>
																<a class="dropdown-item" href="<?= site_url('mentor/dashboard') ?>">Dashboard</a>
															</li>
															<li>
																<a class="dropdown-item" href="<?= site_url('video/detail') ?>">Video Detail</a>
															</li>
														</ul>
													</li>
													<li class="dropdown">
														<a class="dropdown-item dropdown-toggle" href="<?= site_url('blog') ?>">
															Blog
														</a>
													</li>
													<li class="dropdown">
													...
													<li class="dropdown">
														<a class="dropdown-item dropdow-toggle" href="#"><i class="fa fa-user-circle"></i> <span class="pl-3">Yudi Setiawan</span></a>
														<ul class="dropdown-menu">
															<li>
																<a class="dropdown-item" href="<?= site_url('member/register') ?>">Member Registration</a>
															</li>
															<li>
																<a class="dropdown-item" href="<?= site_url('member/dashboard') ?>">Member Dashboard</a>
															</li>
														</ul>
													</li>
									...
									<div class="header-nav-features header-nav-features-light header-nav-features-no-border header-nav-features-lg-show-border order-1 order-lg-2">
										<div class="header-nav-feature header-nav-features-search d-inline-flex">
											...
											<a class="btn btn-warning btn-rounded btn-modern btn-sm mx-3" href="#" data-toggle="modal" data-target="#defaultModal">Keluar</a>
						...
						<div class="modal-body p-5">
							...
							<form class="mb-0" action="index.html" method="post">
								<div class="form-group">
									<input class="form-control" type="text" name="" value="" placeholder="Email/Username">
								</div>
								<div class="form-group">
								...
								<div class="form-row">
									<div class="form-group col-lg-4">
										<button type="button" name="button" class="btn btn-warning btn-rounded btn-modern">Masuk</button>
									</div>
									<div class="form-group col-lg-4">
