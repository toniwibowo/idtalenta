	...
	<div class="col-sm-3">
		<div class="box box-primary">
			<div class="box-body box-profile">
				<img class="profile-user-img img-responsive img-circle" src="<?php echo $this->ion_auth->user()->row()->photo == '' ? base_url('assets/img/logo/kotaxdev.png') : base_url('assets/uploads/image/'.$this->ion_auth->user()->row()->photo) ?>" alt="User profile picture">
