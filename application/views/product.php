        ...
        <div class="col">
          ...
          <div class="row about-cols">
              ...
              <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                  ...
                  <div class="carousel-item <?php if($key==0){ echo 'active ';} ?> ">
                    <img class="d-block w-100" src="<?php echo base_url('assets/uploads/files/'.$row['image_small']); ?>" alt="First slide">
                  </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 column wow fadeInUp" key={fitur.id}>
              ...
              <div class="about-col">
                <div class="img">
                  <a href="<?php echo site_url('product/detail/'.$row['product_id'].'/'.url_title($row['product_name'])); ?>"><img src="<?php echo base_url().'assets/uploads/files/'.$row['image_small']; ?>" alt="" class="img-fluid" /></a>
                  <!--<div class="icon">-->
