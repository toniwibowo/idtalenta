    ...
    <div class="row justify-content-center my-5">
      <div class="col-lg-3 text-center">
        <div class="heading text-primary heading-border heading-bottom-border">
          <h1><strong class="font-weight-extra-bold">Kontak</strong></h1>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-6">
        ...
        <div class="appear-animation mb-4" data-appear-animation="fadeIn" data-appear-animation-delay="800">
          ...
          <ul class="list list-icons list-icons-style-2 mt-2">
            <li><i class="fas fa-map-marker-alt top-6"></i> <strong class="text-dark">Address:</strong> The City Tower Level 12 1N</li>
            <li><i class="fa fa-phone top-6"></i> <strong class="text-dark">Phone:</strong> 089-8123-8123</li>
            <li><i class="fa fa-envelope top-6"></i> <strong class="text-dark">Email:</strong> <a href="mailto:support@idtalenta.com">support@idtalenta.com</a></li>
          </ul>
        </div>
        ...
        <div class="appear-animation mb-4" data-appear-animation="fadeIn" data-appear-animation-delay="950">
          ...
          <ul class="list list-icons list-dark mt-2">
            <li><i class="far fa-clock top-6"></i> Monday - Friday: 8:30 - 17:00</li>
