      ...
      <div class="col-lg-3">
        ...
        <?php if($categoryProduct->num_rows()>0): ?>
          <?php foreach($categoryProduct->result_array() as $r): ?>
									...
									<li class="nav-item"><a class="nav-link" href="<?php echo site_url('product/category/'.$row['category_product_id'].'/'.url_title($r['category_product_name_id'])) ?>">
									<?php echo $r['category_product_name_id']; ?></a></li>
            ...
            <div class="tabs tabs-product mb-2">
              ...
              <div class="tab-content p-0">
                ...
                <div class="tab-pane p-4" id="productInfo">
                  <?php if($row['PDF']!=''): ?>
                    <a href="<?php echo base_url().'assets/uploads/files/'.$row['PDF']; ?>" target ="_blank">Click Here To Download</a>
                  <?php endif ?>
                </div>
        ...
        <div class="row my-5">
          <div class="col-12 col-sm-6 col-lg-3 product">
            <div class="card p-3 mb-4">
              <a href="https://www.tokopedia.com/sanecomme" target="_blank"><img src="<?= base_url() ?>images/marketplace/tokopedia.png" class="img-fluid" alt="Tokopedia"></a>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6 col-lg-3 product">
            <div class="card p-3 mb-4">
              <a href="https://shopee.co.id/saranaabadinusantara" target="_blank"><img src="<?= base_url() ?>images/marketplace/shopee.png" class="img-fluid" alt="Shopee"></a>
            </div>
          </div>
