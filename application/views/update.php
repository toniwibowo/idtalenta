  ...
  <section class="section section-register m-0 border-0">
    <div class="container">
      <div class="row no-gutters register-box">
        <div class="col"></div>
        <div class="col p-5">
          <h4>Update <strong>Profile</strong></h4>
          <form class="" action="<?php echo base_url().'member/register_act' ?>" method="post">
            <div class="form-group">
              <input class="form-control" type="text" name="nama" value="" placeholder="Nama Lengkap" required oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')">
              <?php echo form_error('nama'); ?>
            </div>
             <div class="form-group">
              <input class="form-control" type="email" name="nama" value="" placeholder="Email" required oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')">
              <?php echo form_error('nama'); ?>
            </div>
             <div class="form-group">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <input class="form-control" type="password" name="nama" value="" placeholder="Password Lama" required oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')">
              <?php echo form_error('nama'); ?>
            </div>
             <div class="form-group">
              <input class="form-control" type="password" name="nama" value="" placeholder="Password Baru" required oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')">
              <?php echo form_error('nama'); ?>
            </div>
             <div class="form-group">
              <input class="form-control" type="password" name="nama" value="" placeholder="Konfirmasi Password" required oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')">
              <?php echo form_error('nama'); ?>
            </div>
            <div class="form-group">
