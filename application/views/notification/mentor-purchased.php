    ...
    <div class="container" style="max-width:660px; margin: 0 auto; padding:1%;">
      <div class="row" style="background-color:#fff; padding:20px">
        <table class="table-header" style="width:100%">
          <tr>
            <td align="center">
              <img src="<?= base_url('images/logo/logo-2.png') ?>" style="max-width:180px" alt="">
        ...
        <table class="table-title" style="width:100%; margin-top:20px; border-bottom:solid thin #0088CC; padding-bottom:20px; margin-bottom:20px">
          ...
          <tr>
            <td align="center" colspan="2">
              ...
              <p style="display:inline-block; border:solid thin #0088CC; padding:10px;">Status : <?= $row->payment == 0 ? 'Menunggu Pembayaran' : 'Dibayarkan';  ?></p>
            </td>
          </tr>
        </table>
        ...
        <table style="width:100%; border-collapse: collapse; border: solid thin #ccc; border-color:#ccc;" border="1">
          ...
          <tbody>
            ...
            <?php $listInvoice = $this -> db -> where('order_id',$row->order_id) -> where('product_id',$mentorClass->mentor_class_id) -> from('order_item') -> join('mentor_class','mentor_class.mentor_class_id=order_item.product_id')->get();  ?>
